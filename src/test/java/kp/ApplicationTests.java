 ...
 * {@link KpSelector}, and {@link KpDestination}.
 * <p>
 * It uses the {@link PulsarContainer}.
 * </p>
 */
class ApplicationTests {
    ...
    private static final Function<Message<Information>, String> MESSAGE_FUN =
            message -> ("message: topic[%s], key[%s], sequenceId[%s], messageId[%s]").formatted(
    ...
    void shouldRespondToOriginator() throws Exception {
        ...
        boolean flag = countDownLatch.await(WAIT_AFTER_START, TimeUnit.SECONDS);
        // THEN
        ...
        logger.info("shouldRespondToOriginator(): flag[{}]", flag);
    }
