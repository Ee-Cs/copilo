...
public class EllipticCurveCryptography {
     ...
     */
    private EllipticCurveCryptography() {
    ...
    public static void launch() {
        ...
        try {
            launchWithSecurityExceptionsThrowing();
        } catch (Exception e) {
            Printer.printExc(e);
            System.exit(1);
        }
     ...
     */
    private static void launchWithSecurityExceptionsThrowing() throws NoSuchAlgorithmException,
     ...
     * @throws InvalidAlgorithmParameterException the security exception
     */
    private static KeyPairGenerator initKeyPairGenerator()
     ...
     */
    private static void generateKeyPairECDSA(PrivateBox privateBox, PublicStaticBox publicStaticBox,
     ...
     * @param keyPairGenerator   the key pair generator
     */
    private static void generateKeyPairECDH(PrivateBox privateBox, PublicEphemeralBox publicEphemeralBox,
                                            KeyPairGenerator keyPairGenerator) {
		/*-
		Person:
     ...
     * @throws SignatureException       the security exception
     */
    private static void signPublicKeyECDHWithPrivateKeyECDSA(PrivateBox privateBox, PublicEphemeralBox publicEphemeralBox)
     ...
     * @throws InvalidKeySpecException  the security exception
     */
    private static void verifyCounterpartPublicKeys(String name, PublicStaticBox counterpartPublicStaticBox,
     ...
     * @throws NoSuchAlgorithmException the security exception
     */
    private static PublicKey verifyCounterpartPublicKeyECDSA(PublicStaticBox counterpartPublicStaticBox)
     ...
     * @throws SignatureException       the security exception
     */
    private static void verifyCounterpartPublicKeyECDH(PublicEphemeralBox counterpartPublicEphemeralBox,
     ...
     * @throws InvalidKeySpecException  the security exception
     */
    private static void computeSecretKey(String name, PrivateBox privateBox,
                                         PublicEphemeralBox counterpartPublicEphemeralBox)
		...
		*/
        ...
        /*
         * Key agreement is a protocol by which two or more parties can establish the same
     ...
     * @throws NoSuchPaddingException             the cryptography exception
     */
    private static String encrypt(String cleartext, byte[] secret)
     ...
     * @throws BadPaddingException                the cryptography exception
     */
    private static String decrypt(String encrypted, byte[] secret)
    ...
    /**
     * The box with the public static data.
     * <p>
     * These data were exchanged offline between the person and its counterpart.
     * </p>
     */
    ...
    /**
     * The box with the public ephemeral data.
     * <p>
